...
namespace LG.DLFinance.Tests.SL
{
    ...
    class AdminControllerTests
    {
        ...
        public void Setup()
        {
            ...
            GeneralService generalService = new GeneralService(context.Object);
            TransactionService transactionService = new TransactionService(context.Object, generalService);
